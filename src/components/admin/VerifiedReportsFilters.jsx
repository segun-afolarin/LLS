...
const VerifiedReportsFilters = ({ darkMode, activeDepartment, setActiveDepartment, search, setSearch }) => {
  return (
    <div
      ...
      <div className="max-w-[1400px] mx-auto space-y-3">
        ...
        >
          ...
          <input
            ...
            placeholder="Search by title, report ID, or student..."
...
export default VerifiedReportsFilters;