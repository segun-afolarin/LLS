...
const CampusFeed = () => {
  ...
  /* Filter state lives at the page level — passed down to the filter bar
     and the list, which stay presentational. */
    ...
    <div className={`relative min-h-screen transition-colors duration-500 ${darkMode ? "bg-[#0A0A0C] text-white" : "bg-surface-light text-text"}`}>
      ...
      >
        <div className="max-w-[1100px] mx-auto space-y-6">
          ...
          <FeedList darkMode={darkMode} activeCategory={activeCategory} activeSort={activeSort} search={search} />
        </div>
      </main>
